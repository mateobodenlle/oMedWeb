...
const Dashboard = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const patientsData = [
                    { id: 1, name: 'Candela Tesouro', relation: 'Esposa', avatar: 'M' },
                ...
                const medicationsData = [
                    { id: 1, patientId: 1, name: 'Amitriptilina', dosage: '500mg', frequency: 'Cada 4 horas', remainingDays: 7, totalDays: 10 },
                    { id: 16, patientId: 1, name: 'Ibuprofeno', dosage: '500mg', frequency: 'Cada 8 horas', remainingDays: 7, totalDays: 10 },
                    { id: 17, patientId: 1, name: 'Omeprazol', dosage: '500mg', frequency: 'Cada 12 horas', remainingDays: 7, totalDays: 10 },
                    { id: 18, patientId: 1, name: 'Paracetamol', dosage: '500mg', frequency: 'Cada 8 horas', remainingDays: 7, totalDays: 10 },
                    { id: 19, patientId: 1, name: 'Roacutan', dosage: '500mg', frequency: 'Cada 12 horas', remainingDays: 7, totalDays: 10 },
                    { id: 20, patientId: 1, name: 'Fluimicil', dosage: '600mg', frequency: 'Cada 8 horas', remainingDays: 9, totalDays: 10 },
                ...
                const dosesData = [
                    ...
                    { id: 32, medicationId: 1, patientId: 1, taken: true, scheduledTime: '2025-02-13T08:00', takenTime: '2025-02-13T08:10' },
                    { id: 33, medicationId: 1, patientId: 1, taken: true, scheduledTime: '2025-02-13T16:00', takenTime: '2025-02-13T16:15' },
                    { id: 34, medicationId: 1, patientId: 1, taken: true, scheduledTime: '2025-02-14T00:00', takenTime: '2025-02-14T00:05' },
                    { id: 35, medicationId: 1, patientId: 1, taken: false, scheduledTime: '2025-02-14T08:00', takenTime: null },
                    { id: 36, medicationId: 1, patientId: 1, taken: true, scheduledTime: '2025-02-14T16:00', takenTime: '2025-02-14T16:10' },

                    // --- Dosis de Fluimucil (11) paciente 1
                    { id: 37, medicationId: 20, patientId: 1, taken: true, scheduledTime: '2025-02-26T09:00', takenTime: '2025-02-26T09:05' },
                    { id: 38, medicationId: 20, patientId: 1, taken: true, scheduledTime: '2025-02-26T17:00', takenTime: '2025-02-26T17:10' },
                    { id: 39, medicationId: 20, patientId: 1, taken: true, scheduledTime: '2025-02-27T01:00', takenTime: '2025-02-27T01:15' },
                    { id: 40, medicationId: 20, patientId: 1, taken: false, scheduledTime: '2025-02-27T09:00', takenTime: null },
                    { id: 41, medicationId: 20, patientId: 1, taken: true, scheduledTime: '2025-02-27T17:00', takenTime: null },
                    { id: 42, medicationId: 20, patientId: 1, taken: true, scheduledTime: '2025-02-28T01:00', takenTime: null },
